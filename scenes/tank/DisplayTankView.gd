...
func _draw() -> void:
	...
	draw_string(font, tank_rect.position + Vector2(tank_rect.size.x - 480.0, 22.0), "CoralReefIdleV3 · M17-T02 · 51a5e2b", HORIZONTAL_ALIGNMENT_RIGHT, 460.0, 12, Color(0.78, 0.84, 0.84))
