...
Tag (oldest → newest):
  ...
  v3.5-m17-t01-final-closure-candidate                   944a5e0  (closure docs)
```
...
- **Package version**: v2 (consistency hotfix)
...
- **Closure candidate tag**: `v3.5-m17-t01-final-closure-candidate-v2`
