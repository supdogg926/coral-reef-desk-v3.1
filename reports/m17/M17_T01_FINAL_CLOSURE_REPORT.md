...
**Current HEAD**: `12d37ab25efa3f48906bca3773e333eecacbbf49`
...
All tests run at HEAD (12d37ab), Godot 4.7 headless.
...
| m16_t02_rescue_card_verify | 55P/16F | **Expected** — 3 new species use placeholder source, not image2_user_generated |
| m16_t03_codex_visual_verify | PASS | 35 passed, 0 failed |
| m14_rescue_core_verify | FAIL | **Expected** — species selection divergence from pool expansion |
| m14_t02_rescue_ui_verify | FAIL | **Expected** — flow tests depend on simulation state diverged by species selection |
| m14_t03_copy_ui_verify | FAIL | **Expected** — copy text references diverge with different species |

All failures at HEAD are species-selection consequences per Rebaseline Protocol v2. No non-species configuration changes detected.
...
**New baseline**: HEAD (commit 12d37ab) — 6-species pool
...
- **M17-T01 acceptance**: PASS (re-confirmed at HEAD)
...
5. **M14/M15 regression at HEAD**: Expected divergence due to Rebaseline Protocol v2 (species selection differences). Original regression at T01 commit was all PASS.
